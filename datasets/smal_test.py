...
class smaltest(torch.utils.data.Dataset):
    MESH_FILE_EXT = 'obj'
    ...
    def modify_commandline_options(parser):
        ...
        parser.add_argument('--smpl_root', type=str, default='../smal-data', help='')
        parser.add_argument('--smpl_list', type=str, default='./animal_test_list.txt', help='')
        # parser.add_argument('--smpl_list2', type=str, default='../smpl_unsup.txt', help='')
    ...
    def get_sample(self, index):
        ...
        name,name_2,name_3=names.split(' ')
