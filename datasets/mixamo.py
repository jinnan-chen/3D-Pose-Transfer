...
class mixamo(torch.utils.data.Dataset):
    MESH_FILE_EXT = 'obj'
    ...
    def modify_commandline_options(parser):
        ...
        parser.add_argument('--mixamo_root', type=str, default='/home/jin/Downloads/mixamo_dataset_obj', help='')
    ...
    def __init__(self, opt):        
        ...
        self.dataset,  self.counts_dic = self.load_dataset()
    ...
    def convert_ends(self,dic):
        ...
        for key in dic:
            ...
            # print(end2,end1)
        return dic_ends
    def _load_from_action_split(self, mixamo_root):
        count_dic={}
    ...
    def load_dataset(self):
        ...
        names,counts_dic = self._load_from_action_split(self.opt.mixamo_root)
