...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--dataset", type=str, default='mixamo', help="dataset name")
        ...
        parser.add_argument("--log_dir", type=str, help="log directory", default="../kd_log")
        ...
        parser.add_argument("--n_iterations", type=int, default=60000, help="")
        ...
        parser.add_argument("--model", type=str, default='deformer', help="")
